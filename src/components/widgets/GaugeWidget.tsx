...
export function GaugeWidget({
  ...
  const [currentMinValue, setCurrentMinValue] = useState(props.minValue || minValue);
  const [currentMaxValue, setCurrentMaxValue] = useState(props.maxValue || maxValue);
      ...
      <div className="h-full flex flex-col items-center justify-center p-2">
        {showSettings && (
          <div className="w-full bg-gray-100 dark:bg-botbot-darker rounded-md p-3 mb-4 text-sm overflow-y-auto max-h-[40vh]">
            <div className="mb-3">
              <label className="block text-gray-700 dark:text-gray-300 mb-1">Gauge Name</label>
              <input
                type="text"
                value={currentTitle}
            ...
            <div className="mb-3">
              <label className="block text-gray-700 dark:text-gray-300 mb-1">ROS Topic</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-2">
              <div>
                <label className="block text-gray-700 dark:text-gray-300 mb-1">Min Value</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-gray-700 dark:text-gray-300 mb-1">Max Value</label>
                <input
                  type="number"
